...
/// Lista de países mockada, apenas para fins de layout/apresentação.
/// Quando a integração real com a REST Countries API for feita, esta
/// lista pode ser substituída pelo resultado da chamada HTTP.
...
List<String> get mockRegions {
  final regions = mockCountries.map((c) => c.region).toSet().toList();
  regions.sort();
  return regions;
}
